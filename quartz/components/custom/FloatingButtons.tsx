...
// @ts-ignore
import script from "../scripts/custom/floatingButtons.inline"
import style from "../styles/custom/floatingButtons.scss"
    ...
    return (
      <div class={classNames(displayClass, "floating-buttons", `floating-${position}`)}>
        <div class="button-group">
          ...
          {/* GRAPH BUTTON */}
          <button class="floating-button" title="graph" data-action="graph">
